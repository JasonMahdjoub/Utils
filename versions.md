...
### 4.13.0 STABLE (16/03/20)
* Add ProgressMonitor class


### 4.12.0 STABLE (25/02/20)
* Add FileTools.walkFileTree function


### 4.11.0 STABLE (17/02/20)
...
### 4.6.1 STABLE (19/10/19)
* Update dependencies


### 4.6.0 STABLE (17/10/19)
* Add cache file center


### 4.5.3 STABLE (16/10/19)
...
### 4.4.3 STABLE (10/07/19)
* Add secure serialization tools.


### 4.3.1 STABLE (28/06/19)
...
### 3.23.0 STABLE (04/12/18)
* Add P2P login asymmetric signature


### 3.22.0 STABLE (12/11/18)
...
### 3.2.0 STABLE (06/10/17)
* Changing default JVM secured random


### 3.1.1 STABLE (06/10/17)
...
### 2.15.1 STABLE (21/08/17)
* Minimal corrections


### 2.15.0 STABLE (15/08/17)
...
### 1.8.0 STABLE (13/10/16)
* Adding password hash (PBKF and bcrypt)


### 1.7.2 STABLE (15/09/16)
