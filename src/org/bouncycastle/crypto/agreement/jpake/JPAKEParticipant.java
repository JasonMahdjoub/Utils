...
public class JPAKEParticipant
{
     ...
     * </p>
     */
    private byte[] messageKeyOrPassword;
        ...
        SecureRandom random)
    {
         ...
         */
        this.messageKeyOrPassword = Arrays.copyOf(messageKeyOrPassword, messageKeyOrPassword.length);
    ...
    public JPAKERound2Payload createRound2PayloadToSend() throws IOException
    {
        ...
        BigInteger s = JPAKEUtil.calculateS(messageKeyOrPassword);
    ...
    public BigInteger calculateKeyingMaterial()
    {
         ...
         */
        Arrays.fill(messageKeyOrPassword, (byte)0);
        this.messageKeyOrPassword = null;
