...
public final class FileTools {
	 ...
	 * @param include_source_forder tells if the source directory must be included with the copy, and not only its content
	 * @throws IOException if a problem occurs
	 */
	 ...
	 * @param destinationFolder Destination directory.
	 * @param include_source_forder tells if the source directory must be included with the copy, and not only its content
	 * @param _exclude_regex the regex that enables to exclude files
	 * @param _include_regex the regex that enables to include files
	 * @throws IOException if a problem occurs
	 */
	public static void copyFolderToFolder(File sourceFolder, File destinationFolder, boolean include_source_forder, String _exclude_regex, String _include_regex) throws IOException {
	    copyFolderToFolder(sourceFolder, include_source_forder?sourceFolder.getName():"",sourceFolder, destinationFolder, _exclude_regex, _include_regex);
	}
	 ...
	 * @param sourceFolder Source directory.
	 * @param destinationFolder Destination directory.
	 * @param regex_exclude the regex that enables to exclude files
	 * @param regex_include the regex that enables to include files
	 * @throws IOException if a problem occurs
	 */
	private static void copyFolderToFolder(File currentFolder,
			String relatedPath, File sourceFolder, File destinationFolder, String regex_exclude, String regex_include) throws IOException {
		// Current Directory.
		
		if (currentFolder.isDirectory() && FileTools.matchString(currentFolder.getAbsolutePath(), regex_exclude, regex_include)) {
	...
	public static void removeFiles(ArrayList<String> files,
			File projectDirectory) throws IOException {
	 ...
	 * @param _zip_file the zip or jar file
	 * @param _directory_dst the destination where the ZIP/JAR file is unzip
	 * @throws IOException if a problem occurs
	 */
	 ...
	 * @param _directory the directory to zip
	 * @param _include_directory tells if the directory must be included into the ZIP/JAR file, or if only its content must be included
	 * @param _zipfile the destination ZIP/JAR file
	 * @throws IOException if a problem occurs
	 */
